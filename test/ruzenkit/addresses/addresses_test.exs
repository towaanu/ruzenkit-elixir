defmodule Ruzenkit.AddressesTest do
  ...
  describe "countries" do
    ...
    test "create_country/1 with valid data creates a country" do
      ...
      assert country.english_name == "germany"
      assert country.local_name == "Deutschland"
      assert country.long_iso_code == "DEU"
      assert country.short_iso_code == "DE"
    end
    ...
    test "update_country/2 with valid data updates the country" do
      ...
      assert country.english_name == "france"
      assert country.local_name == "France"
      assert country.long_iso_code == "FRA"
      assert country.short_iso_code == "FR"
    end
  ...
  describe "addresses" do
    ...
    def address_fixture(attrs \\ %{}) do
      {:ok, %{id: country_id}} = Addresses.create_country(@country_attrs)
